...
import { Button, Text, Divider, NavLink, Spinner, Alert, Close, Box, Paragraph } from 'theme-ui';
      ...
      <div style={{ minHeight: "100vh" }}>
        ...
        >
          ...
          <>
            ...
            >
                <Paragraph sx={{maxWidth: 300, fontSize: 20, fontWeight: 400, mt: 2}}>
                ...
                <Paragraph sx={{maxWidth: 300, fontSize: 20, fontWeight: 400, pt: 5}}>
                    At the moment, <GradientText text={`YSN `} />
                    is minted every time you interact with <GradientText text={` SHARE`} />.
                    The <GradientText text={`NEAR`} /> treasury grows through {" "}
                    <GradientText text={` SHARE`} /> sales and royalties.
                </Paragraph>
                </Box>
                <Paragraph sx={{maxWidth: 300, fontSize: 20, fontWeight: 400, mt: 5}}>
